...
{
    public partial class ListadoDiasServicio : Listado
    {
        public ListadoDiasServicio(DateTime desde, DateTime hasta)
        {
            InitializeComponent();
            this.Query = "select top 5 * from DEL_NAVAL.micros_fuera_servicio(@desde, @hasta)";
