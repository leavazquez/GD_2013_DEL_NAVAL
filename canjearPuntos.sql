...
Begin
 ...
 select PU.cliente, PU.puntos, PU.fecha, PU.usados, NULL,  NULL,  NULL,  NULL
  from DEL_NAVAL.puntos PU
  where PU.cliente = @cliente
 union 
  select CA.cliente, NULL, NULL, NULL, CA.producto, CA.cantidad, CA.fecha_canje, CA.puntos_canjeados
